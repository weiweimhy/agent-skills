---
name: vue
description: Vue 3 development guidance for Composition API, script setup, composables, Pinia, Vite, SSR boundaries, and component structure. Use when building or reviewing Vue UI, composables, or state management.
---
...
- [api-design](../api-design/SKILL.md): 涉及前端与后端接口的集成规范。
