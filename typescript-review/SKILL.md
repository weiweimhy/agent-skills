...
description: TypeScript code review guidance for type safety, generics, narrowing, public API types, runtime validation alignment, async flow, TSX, and strict tsconfig. Use when reviewing .ts or .tsx files, Node/React/Vue TypeScript, or complex types.
---
...
- [api-design](../api-design/SKILL.md): 涉及 API 层面的设计审查。
- [backend-patterns](../backend-patterns/SKILL.md): 涉及后端架构层面的架构审计。
