...
description: Translate vague product requests into user stories, PRDs, acceptance criteria, priorities, and task breakdowns. Use when requirements are unclear, need scoping, or need product-to-engineering translation.
---
...
- [api-design](../api-design/SKILL.md): 需求转技术后的 API 设计
