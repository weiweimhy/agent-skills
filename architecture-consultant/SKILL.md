...
description: Cross-project architecture consulting for system design, technical selection, service boundaries, trade-off analysis, ADRs, and Mermaid/C4 architecture diagrams. Use when requests mention architecture design, refactoring direction, tech choice, scalability, reliability, or architectural decision records.
---
