...
description: Backend architecture patterns for project structure, module boundaries, service and repository layers, caching, retries, transactions, observability, and security defaults. Use when designing or refactoring backend systems across Go, Python, TypeScript, or other stacks.
---
...
- [architecture-consultant](../architecture-consultant/SKILL.md): 涉及系统级权衡时可上升到架构咨询层面。
